...
# auto generate the resource pytyhon file
qrc_file = BASE_DIR / f"resources/pic.qrc"
py_qrc_file = BASE_DIR / f"resources/pic_rc.py"
cmd = ["pyrcc5", str(qrc_file), "-o", str(py_qrc_file)]
print("Converting:", qrc_file.name, "->", py_qrc_file.name)
