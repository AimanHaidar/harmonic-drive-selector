...
# Form implementation generated from reading ui file '/home/aymanhadair/AI/harmonic-drives-selector/utils/harmonic_drive_selector/gui/ui/data_dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.array_s.setGeometry(QtCore.QRect(270, 0, 61, 41))
        self.array_s.setObjectName("array_s")
        self.json_s = QtWidgets.QRadioButton(Dialog)
        self.json_s.setGeometry(QtCore.QRect(360, 0, 91, 41))
        ...
        self.dataTable.setGeometry(QtCore.QRect(30, 50, 371, 121))
        ...
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsDropEnabled|QtCore.Qt.ItemIsUserCheckable)
        self.dataTable.setItem(0, 4, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsDropEnabled|QtCore.Qt.ItemIsUserCheckable)
        self.dataTable.setItem(1, 4, item)
        self.dataTable.horizontalHeader().setDefaultSectionSize(50)
        self.file_path = QtWidgets.QLineEdit(Dialog)
        self.file_path.setEnabled(True)
        self.file_path.setGeometry(QtCore.QRect(20, 90, 391, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "your tourqe/angular speed data:"))
        item = self.dataTable.verticalHeaderItem(0)
        item.setText(_translate("Dialog", "Tourqe"))
        item = self.dataTable.verticalHeaderItem(1)
        item.setText(_translate("Dialog", "Anglur Speed"))
        item = self.dataTable.verticalHeaderItem(2)
        item.setText(_translate("Dialog", "timestamps"))
